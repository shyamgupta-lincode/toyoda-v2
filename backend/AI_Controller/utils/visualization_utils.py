...
def visualize_boxes_and_labels_on_image_array(
  ...
  print("BOX DISPLAY STRING : : : : : ", box_to_display_str_map ) 
  # Draw all boxes onto image.
  for box, color in box_to_color_map.items():
    print(box_to_display_str_map[box][0])
    if 'Absen' in  box_to_display_str_map[box][0] or 'absen' in box_to_display_str_map[box][0] :
      color1 = 'Blue'
    else:
      color1 = 'Green'

    if "Shot_Shot_Presence" in  box_to_display_str_map[box][0]:
      color1 = 'Blue'
    elif "Shot_Shot_Absence" in  box_to_display_str_map[box][0]:
      color1 = 'Green' 
