...
#]
#
STANDARD_COLORS = [ 'RoyalBlue', 'Green']
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    if 'Prese' in display_str:
      print("colorcheck : : : :" , "present")
    ...
    if 'Absen' in display_str:
      print("colorcheck : : : :" , "absent")
      text_width, text_height = font.getsize(display_str)
      margin = np.ceil(0.05 * text_height)
      draw.rectangle(
          [(left, text_bottom - text_height - 2 * margin), (left + text_width,
...
def draw_bounding_boxes_on_image(image,
  ...
  for i in range(boxes_shape[0]):
    ...
    if display_str_list_list:
      ...
      print("YAHHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAN : : : : : : ", display_str_list)
    if 'presen' in display_str_list:
      draw_bounding_box_on_image(image, boxes[i, 0], boxes[i, 1], boxes[i, 2],
                               boxes[i, 3], 'green', thickness, display_str_list)
    elif 'absen' in display_str_list:
      draw_bounding_box_on_image(image, boxes[i, 0], boxes[i, 1], boxes[i, 2],
                               boxes[i, 3], 'blue', thickness, display_str_list)
    else:
      draw_bounding_box_on_image(image, boxes[i, 0], boxes[i, 1], boxes[i, 2],
                               boxes[i, 3], 'yellow', thickness, display_str_list)
